document.addEventListener("DOMContentLoaded", () => {
  const brands = [
    {
      name: "Milestones",
      logo: "FoodtasticPortalsIntProd/images/Milestones Logo White.png",
      url: "https://milestones.integratedproductions.com/",
      color: "linear-gradient(135deg,rgb(0, 132, 255),rgb(0, 38, 255))",
    },
    {
      name: "Freshii",
      logo: "FoodtasticPortalsIntProd/images/Freshii Green Logo.png",
      url: "https://freshii.integratedproductions.com/",
      color: "linear-gradient(135deg, #00cc66, #009933)",
    },
    {
      name: "Quesada",
      logo: "FoodtasticPortalsIntProd/images/Quesada Logo Enhanced.png",
      url: "https://quesada.integratedproductions.com/",
      color: "linear-gradient(135deg,rgb(201, 0, 0),rgb(160, 1, 1))",
    },
    {
      name: "O'Tacos",
      logo: "FoodtasticPortalsIntProd/images/O Tacos Logo.png",
      url: "https://otacos.integratedproductions.com/",
      color: "linear-gradient(135deg, #ff6600, #cc3300)",
    },
    {
      name: "Jimmy John's",
      logo: "FoodtasticPortalsIntProd/images/jj-02.png",
      url: "#",
      color: "linear-gradient(135deg,rgb(26, 26, 26),rgb(0, 0, 0))",
    },
    {
      name: "Pita Pit",
      logo: "FoodtasticPortalsIntProd/images/PitaPit-logo-home-page-1.svg",
      url: "#",
      color: "linear-gradient(135deg,rgb(26, 26, 26),rgb(0, 0, 0))",
    },
    {
      name: "Noodlebox",
      logo: "FoodtasticPortalsIntProd/images/NBX_LOGO_2020.png",
      url: "",
      color: "linear-gradient(135deg,rgb(0, 132, 255),rgb(0, 38, 255))",
    },
    {
      name: "Second Cup",
      logo: "FoodtasticPortalsIntProd/images/second-cup-1.svg",
      url: "",
      color: "linear-gradient(135deg, #00cc66, #009933)",
    },
    {
      name: "Shoeless Joe's",
      logo: "FoodtasticPortalsIntProd/images/Shoeless-Joes-Slider.svg",
      url: "",
      color: "linear-gradient(135deg,rgb(201, 0, 0),rgb(160, 1, 1))",
    },
    {
      name: "Rostisseries Benny",
      logo: "FoodtasticPortalsIntProd/images/la-belle.svg",
      url: "",
      color: "linear-gradient(135deg, #ff6600, #cc3300)",
    },
    {
      name: "Rostisseries Benny",
      logo: "FoodtasticPortalsIntProd/images/BENNY-logo-2022.svg",
      url: "",
      color: "linear-gradient(135deg, #ff6600, #cc3300)",
    },
    {
      name: "Fionns",
      logo: "FoodtasticPortalsIntProd/images/FIONNs-logo-HomePage.svg",
      url: "",
      color: "linear-gradient(135deg,rgb(26, 26, 26),rgb(0, 0, 0))",
    },
    {
      name: "Monza",
      logo: "FoodtasticPortalsIntProd/images/monza.svg",
      url: "",
      color: "linear-gradient(135deg,rgb(26, 26, 26),rgb(0, 0, 0))",
    },
    {
      name: "Souvlaki Bar",
      logo: "FoodtasticPortalsIntProd/images/souvlaki-bar.svg",
      url: "",
      color: "linear-gradient(135deg,rgb(0, 132, 255),rgb(0, 38, 255))",
    },
    {
      name: "Fusee",
      logo: "FoodtasticPortalsIntProd/images/Fusee-logo-2022.svg",
      url: "",
      color: "linear-gradient(135deg, #00cc66, #009933)",
    },
    {
      name: "Rostissieries Au Coq",
      logo: "FoodtasticPortalsIntProd/images/AuCoq-logo-2022.svg",
      url: "",
      color: "linear-gradient(135deg,rgb(201, 0, 0),rgb(160, 1, 1))",
    },
    {
      name: "Copper Branch",
      logo: "FoodtasticPortalsIntProd/images/69496-003-CopperBranch-Slider-1.svg",
      url: "",
      color: "linear-gradient(135deg, #ff6600, #cc3300)",
    },
    {
      name: "Chocolato",
      logo: "FoodtasticPortalsIntProd/images/chocolato.svg",
      url: "",
      color: "linear-gradient(135deg,rgb(26, 26, 26),rgb(0, 0, 0))",
    },
    {
      name: "Nickels",
      logo: "FoodtasticPortalsIntProd/images/nickels.svg",
      url: "",
      color: "linear-gradient(135deg,rgb(26, 26, 26),rgb(0, 0, 0))",
    },
    {
      name: "Bacaro",
      logo: "FoodtasticPortalsIntProd/images/baccaro.svg",
      url: "",
      color: "linear-gradient(135deg, #ff6600, #cc3300)",
    },
    {
      name: "Carlos & Pepe’s",
      logo: "FoodtasticPortalsIntProd/images/carlos-and-pepes-logo.png",
      url: "",
      color: "linear-gradient(135deg,rgb(26, 26, 26),rgb(0, 0, 0))",
    },
    {
      name: "Big Rig",
      logo: "FoodtasticPortalsIntProd/images/big-rig.svg",
      url: "",
      color: "linear-gradient(135deg,rgb(26, 26, 26),rgb(0, 0, 0))",
    },
    {
      name: "La Chambre",
      logo: "FoodtasticPortalsIntProd/images/chambre.svg",
      url: "",
      color: "linear-gradient(135deg,rgb(0, 132, 255),rgb(0, 38, 255))",
    },
    {
      name: "Tommy",
      logo: "FoodtasticPortalsIntProd/images/tommy.svg",
      url: "",
      color: "linear-gradient(135deg, #00cc66, #009933)",
    },
    {
      name: "GattoMatto",
      logo: "FoodtasticPortalsIntProd/images/gattomatto.svg",
      url: "",
      color: "linear-gradient(135deg,rgb(201, 0, 0),rgb(160, 1, 1))",
    },
    {
      name: "Le Blossom",
      logo: "FoodtasticPortalsIntProd/images/logo-le-blossom-foodtastic.svg",
      url: "",
      color: "linear-gradient(135deg, #ff6600, #cc3300)",
    },
  ];
